...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SQL para quem vende" },
      {
        name: "description",
        content: "Curso prático de SQL para times comerciais, com PostgreSQL rodando no navegador.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "SQL vende" },
    ],
    links: [
      {
        rel: "stylesheet",
